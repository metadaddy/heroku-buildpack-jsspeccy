...
# base JSSPECCY Language Pack. This is for any base ruby app.
class LanguagePack::JSSPECCY < LanguagePack::Base
  BUNDLER_VERSION     = "1.1.rc"
  BUNDLER_GEM_PATH    = "bundler-#{BUNDLER_VERSION}"
  JSSPECCY_GIT_URL       = "https://github.com/metadaddy-sfdc/jsspeccy.git"

  # detects if this is a valid JSSPECCY app
...
ERROR
  ...
  def setup_jsspeccy
    Dir.mktmpdir("jsspeccy-") do |tmpdir|
      Dir.chdir(tmpdir) do
